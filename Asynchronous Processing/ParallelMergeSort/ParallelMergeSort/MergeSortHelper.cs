...
{
	public class MergeSortHelper<T> where T : IComparable
	{
		...
		public void Sort(T[] array, bool parallel)
		{
			Sort(array, 0, array.Length - 1, parallel);
		}

		public void Sort(T[] array, int low, int high, bool parallel)
		{
		...
		private void ParallelMergeSort(T[] to, T[] temp, int low, int high, int depth)
		{
			...
			// Once both tasks ran to completion merge sorted 
